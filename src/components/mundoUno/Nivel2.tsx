...
import informativa1 from "../../assets/imgInformativas/informativa-nivel2-1.png";
import informativa2 from "../../assets/imgInformativas/informativa-nivel2-2.png";
        ...
        <div className="mb-8">
          <section className="bg-white p-4 rounded-lg mb-4">
            <h2 className="text-xl font-bold text-[#274c47] mb-2">
              "Comprensión de detalles específicos"
            </h2>
            <p className="text-gray-700 text-base">
              Los textos contienen información relevante, es decir,
              significativa y otra que no lo es. Para comprender el texto es
              necesario identificar los detalles relevantes del mismo. La
              relevancia de la información depende de lo que el lector hará con
              ella, es decir depende de para qué la usará, según su propósito de
              lectura usando 6 preguntas:
            </p>
            <br />
            ...
            <br />
            <p className="text-gray-700 text-base">
              <span className="font-bold">Esta habilidad es crucial para:</span>
              <br />
              <br />
            </p>
            <ul className=" text-gray-700 text base pl-5">
              <li>• Idetificar ideas principales</li>
              <li>• Elaborar resúmenes</li>
              <li>• Comprender el sentido global del texto</li>
              <li>• Responder preguntas específicas sobre el contenido</li>
            </ul>
            <br />
            <p className="text-gray-700 text-base">
              <span className="font-bold">
                Estrategias para identificar detalles
              </span>
            </p>
            <br />
            <ul className="pl-5 text-gray-700 text base">
              <li>1. Lectura atenta del texto</li>
              <li>2. Elaborar resúmenes</li>
              <li>3. Selección de información relevante según el propósito</li>
              <li>
                4. Verificación de que los detalles seleccionados cumplen con el
                objetivo de lectura (responden por lo menos a alguna de las 6
                preguntas )
              </li>
            </ul>
            <p className="text-gray-700 text-base">
              ...
              <span className="italic">
                Juan tenía 15 cincos, pero de camino a la escuela perdió cuatro.
                Su hermana le regaló dos de sus cincos. ¿Cuántos cincos tiene
                ahora Juan?{" "}
              </span>
            </p>
            <div className="flex flex-row items-center content-center justify-center">
            ...
            <p className="text-gray-700 text-base">
              <br />
              <br />
              Ahora se pondrá a prueba tu habilidad en la comprensión de
              detalles con textos más largos y diferentes. Utiliza las
