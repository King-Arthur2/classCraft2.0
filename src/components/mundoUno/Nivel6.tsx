...
import informativa1 from "../../assets/imgInformativas/informativa-nivel6-1.png";
import informativa2 from "../../assets/imgInformativas/informativa-Nivel6-2.png";

const imgInformativas = [informativa1, informativa2];

// Componente principal
const Nivel6: React.FC = () => {
