...
import informativa1 from "../../assets/imgInformativas/informativa-nivel1-1.png";
import informativa2 from "../../assets/imgInformativas/informativa-nivel1-2.png";
  ...
  return (
    <div className="flex h-screen font-poppins">
      ...
      <main className="bg-[#f5deb3] w-4/5 p-5 overflow-y-auto">
        ...
        {/* Texto introductorio del nivel */}
        <div className="mb-8">
          <section className="bg-white p-4 rounded-lg mb-4">
            <h2 className="text-xl font-bold text-[#274c47] mb-2">
              "Las ideas principales y cómo diferenciarlas de las secundarias."
            </h2>
            <p className="text-gray-700 text-base">
              Cuando las ideas y los conceptos se enlazan para transmitir
              mensajes largos y complejos, puede surgir una sobrecarga de
              información que dificulta la comprensión y la retención de lo
              esencial. En estos casos, identificar las ideas principales es
              clave para facilitar la comprensión.
              <br />
              <br />
              La mayoría de los textos escritos en prosa están compuestos por
              párrafos, y cada uno de ellos contiene una idea principal que
              resume su contenido y está relacionada con el tema general del
              texto. En otras palabras, cada párrafo tiene una idea principal
              que actúa como el "esqueleto" del texto. Estas ideas principales
              forman la estructura central del texto, los pilares que sostienen
              su contenido, mientras que las ideas secundarias complementan y
              decoran esa estructura.
            </p>
            <div className="flex flex-row items-center content-center justify-center">
              <img className="w-72" src={informativa1} alt="" />
            </div>
            <p className="text-gray-700 text-base">
              Para identificar la idea principal de un párrafo, es útil analizar
              sus oraciones. Los párrafos suelen incluir una oración principal
              que contiene la información más importante o fundamental,
              acompañada de oraciones secundarias que amplían, explican o
              aportan detalles adicionales.
              <br />
              <br />
              Las oraciones secundarias suelen estar conectadas con la principal
              mediante signos de puntuación como la coma, el punto y coma o el
              punto y seguido, así como por conjunciones y preposiciones. Una
              vez que identificas las ideas principales, puedes utilizar
              herramientas como mapas mentales, cuadros sinópticos, resúmenes y
              síntesis. Estas técnicas de estudio no solo te ayudarán a
              comprender mejor cualquier texto, sino que también facilitarán la
              organización y memorización de la información.
              <br />
              <br />
              <span className="font-bold">Definición y Características</span>
              Las ideas principales y secundarias se diferencian por su
              jerarquía e importancia dentro del texto:
            </p>
            <div className="flex flex-row items-center content-center justify-center">
              <img className="w-3/5" src={informativa2} alt="" />
            </div>
            <p className="text-gray-700 text-base">
              <br />
              <br />
              ...
              <br />
              <br />
              Para identificar eficazmente las ideas principales y secundarias,
              se pueden emplear las siguientes técnicas:
              <br />
            </p>
            <ol className="text-gray-700 text-base">
              <li>1. Análisis párrafo por párrafo.</li>
              <li>
                2. Formulación de preguntas clave:
                <ul className="pl-5">
                  <li>• Para ideas principales: "¿De qué trata el texto?"</li>
                  <li>
                    • Para ideas secundarias: "¿Qué información complementa el
                    tema central?"
                  </li>
                </ul>
              </li>
