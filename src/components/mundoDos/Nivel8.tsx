...
import informativa1 from "../../assets/imgInformativas/informativa-nivel8-1.png";
import informativa2 from "../../assets/imgInformativas/informativa-nivel8-2.png";
import informativa3 from "../../assets/imgInformativas/informativa-nivel8-3.png";
import informativa4 from "../../assets/imgInformativas/informativa-nivel8-4.png";
import informativa5 from "../../assets/imgInformativas/informativa-nivel8-5.png";
import informativa6 from "../../assets/imgInformativas/informativa-nivel8-6.png";
// Componente principal
const Nivel8: React.FC = () => {
        ...
        <div className="mb-8">
          <section className="bg-white p-4 rounded-lg mb-4">
            <p className="text-gray-700 text-base">
              El aprendizaje del idioma no es fijo. Al ir creciendo, vas
              adquiriendo un manejo más eficiente del lenguaje, pero también te
              vas acostumbrando a utilizar una serie de palabras de uso
              cotidiano. Esto no quiere decir que las palabras que usas
              normalmente sean las únicas que podrás conocer o que no puedas
              aprender y utilizar más, sino que es preciso que domines sus
              reglas para poder escribirlas y hablarlas de manera adecuada,
              clara y eficiente.
            </p>
            ...
            <br />
            <p className="text-gray-700 text-base">
              Las palabras agudas llevan su sílaba tónica en la última sílaba.
              Las palabras agudas llevan tilde cuando su sílaba tónica termina
              en letra vocal, en letra n o en letra s.
              <br />
              <br />
            </p>
            <div className="flex justify-center mt-4">
            ...
            <p className="text-gray-700 text-base">
              ...
              y llevan tilde cuando terminan en una letra consonante y dicha
              letra no es letra vocal, tampoco letra n ni letra s.
            </p>
            <br />
            <br />
            <div className="flex justify-center mt-4">
            ...
            <br />
            <p className="text-gray-700 text-base">
              Naturalmente, existen en nuestro vocabulario muchas palabras
              graves sin tilde. De hecho, la mayoría de ellas no la lleva. En
              este grupo podemos incluir términos como “saludo” y “cambien”. El
              primero acaba en vocal, mientras que el segundo termina en “n”.
              Por consiguiente, no deben ir acentuados. Sea como sea, la mayor
              parte del tiempo nos toparemos con palabras graves que no
              tendremos que acentuar. Eso nos facilitará mucho la escritura
            </p>
            <br />
            <br />
            <div className="flex justify-center mt-4">
              <img className="w-2/6" src={informativa4} alt="" />
            </div>
            <br />
            <br />
            <h2 className="text-base font-bold text-[#274c47] mb-2">
            ...
            <br />
            <p className="text-gray-700 text-base">
              Las palabras esdrújulas llevan la sílaba tónica en la
              antepenúltima sílaba. Entonces, las esdrújulas deben estar
              compuestas por al menos tres sílabas. Aquí tienes un primer
              criterio de selección: revisar, cuando una palabra sea larga,
              dónde está su sílaba tónica; si es en la antepenúltima sílaba, no
              hay de otra, es una palabra esdrújula.
              <br />
              Debes recordar que todas las palabras esdrújulas llevan siempre
              tilde.
            </p>
            <br />
            <br />
            <div className="flex justify-center mt-4">
              <img className="w-2/6" src={informativa5} alt="" />
            </div>
            <br />
            <br />
            <h2 className="text-base font-bold text-[#274c47] mb-2">
            ...
            <p className="text-gray-700 text-base">
              Las palabras sobresdrújulas llevan la sílaba tónica en la sílaba
              anterior a la antepenúltima y están formadas por al menos cuatro
              sílabas. Al Igual que las esdrújulas, todas llevan tilde.
              <br />
              <br />
              Dentro de la misma clasificación de las palabras esdrújulas están
              las palabras sobresdrújulas. Éstas se distinguen por tener una
              sílaba más que las esdrújulas. Lo anterior se debe a que al poner
              un pronombre enclítico se aumenta el número de sílabas, y por eso
              se les llama a estas palabras “sobresdrújulas”, porque “aumenta”
              una sílaba a la esdrújula.
              <br />
              <br />
              Por Ejemplo:
              <br />
              ...
              <span className="italic">
                gánatela, cómpramela, escríbeselo, notifícamelo, acláramelo…
              </span>
              <br />
              <br />
              Observa cómo una palabra esdrújula se convierte en una palabra
              sobresdrújula al poner un pronombre enclítico:
              <br />
              <br />
              Palabra esdrújula + Pronombre enclítico = Palabra sobresdrújula
              <br />
              <br />
              Tápalo (tá-pa-lo) + se = tápaselo (tá-pa-se-lo)
            </p>
            <div className="flex justify-center mt-4">
              <img className="w-2/6" src={informativa6} alt="" />
            </div>
          </section>
        </div>
