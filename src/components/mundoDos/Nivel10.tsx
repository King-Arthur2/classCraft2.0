...
import informativa1 from "../../assets/imgInformativas/informativa-Nivel10-1.png";

// Componente principal
const Nivel10: React.FC = () => {
        ...
        <div className="mb-8">
          <section className="bg-white p-4 rounded-lg mb-4">
            ...
            <p className="text-gray-700 text-base">
              Es la principal cualidad de un texto escrito y es la que permite
              mantener la unidad temática en las diferentes partes o componentes
              del texto (Martínez Montes, 2007). En otras palabras, la
              coherencia implica la existencia de una relación lógica entre las
              ideas del texto, y que estas ideas o párrafos actúen en conjunto
              para dotar de significado global a un tema principal.
              <br />
              <br />
              Para que un texto sea coherente, cada uno de sus párrafos debe
              estar constituido por un conjunto de enunciados que desarrollan
              una idea principal. Es decir, la coherencia implica que exista una
              idea con significado autónomo que se complementa con ideas
              secundarias mediante las cuales se aclara, explica, ejemplifica o
              amplía su sentido.
              <br />
              <br />
              La coherencia se refiere, por tanto, a la forma en que se
              organizan los enunciados en torno a esta idea principal en el
              párrafo, de tal forma que la secuencia de presentación de estos
              muestre un orden en el que cada enunciado se encadena con el
              siguiente.
            </p>
            <br />
            <br />
            <p className="text-gray-700 text-base">
              Por ejemplo, da lectura al siguiente texto:
            </p>
            <br />
            <br />
            <div className="text-gray-700 text-base text-center italic">
              <p>
                Una de las cosas que me gustaría hacer en mi próxima visita a la
                playa es bucear y ver las coloridas “ciudades submarinas”. He
                leído que muchas personas confunden plantas o rocas con los
                esqueletos de estos animales.
              </p>
            </div>
            <br />
            <br />
            <p className="text-gray-700 text-base">
              ...
              <br />
              <br />
              Es porque la coherencia del texto es deficiente. No existe unidad
              temática entre los dos párrafos del texto. Esto impide que el
              primer enunciado se encadene con el segundo y pone de manifiesto
              que las ideas y el significado del segundo párrafo no se
              complementan con las ideas del primero, es decir en este segundo
              párrafo no se aclara, explica, ejemplifica o amplía el sentido del
              primer párrafo.
              <br />
              <br />
              ...
              <br />
              <br />
              Se refiere a los mecanismos de tipo sintáctico y semántico que se
              emplean para articular las diversas partes del texto, ya sean
              palabras, oraciones o párrafos. Entre estos mecanismos destacan:
              el empleo de conectores (por ejemplo: además, incluso, pero, en
              cambio, por eso, porque, etc.), la repetición, tiempos verbales,
              los pronombres (por ejemplo: este, ese, aquel, cuyo, que, cual),
              los sinónimos y la puntuación (Martínez Montes , 2007).
              <br />
              <br />
            ...
            <div className="text-gray-700 text-base text-center italic">
              <p>
                Estas nuevas modalidades transformaron el proceso de la
                comunicación con tecnología, en el cual los usuarios de internet
                son productores y consumidores de la información que se
                distribuye a través de este sistema.
              </p>
            </div>
            <br />
            <br />
            <p className="text-gray-700 text-base">
              En este texto los elementos que nos hacen percibir que el párrafo
              tiene cohesión son el término “en el cual” que está haciendo
              referencia “al proceso”.
              <br />
              <br />
              El uso correcto de los signos de puntuación (coma, punto y coma,
              punto y aparte, punto y seguido) también contribuyen a que el
              texto tenga cohesión.
              <br />
              <br />
              Tanto la coherencia como la cohesión son características
              esenciales que permiten que un texto sea comprensible y por tanto
