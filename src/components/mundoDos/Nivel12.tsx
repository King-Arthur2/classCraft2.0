...
import informativa1 from "../../assets/imgInformativas/informativa-nivel12-1.png";
import informativa2 from "../../assets/imgInformativas/informativa-Nivel12-2.png";

const imgInformativas = [informativa1, informativa2];

// Componente principal
const Nivel12: React.FC = () => {
  ...
  const [currentLevelIndex] = useState(5);
