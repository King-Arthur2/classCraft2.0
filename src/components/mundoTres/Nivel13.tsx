...
import informativa1 from "../../assets/imgInformativas/informativa-nivel13-1.png";
import informativa2 from "../../assets/imgInformativas/informativa-nivel13-2.png";

// Componente principal
const Nivel13: React.FC = () => {
        ...
        <div className="mb-8">
          <section className="bg-white p-4 rounded-lg mb-4">
            <h2 className="text-xl font-bold text-[#274c47] mb-4">
              Retroalimentación efectiva en la escritura académica
            </h2>
            <p className="text-gray-700 text-base">
              La retroalimentación efectiva es un componente crucial en el
              proceso de mejora de la escritura académica. A continuación, se
              presenta una explicación detallada sobre cómo implementar
              estrategias de retroalimentación para potenciar las habilidades de
              escritura de los estudiantes universitarios.
              <br />
              <br />
              <span className="font-bold">
                Tipos de retroalimentación en la escritura académica
              </span>
              <br />
              <br />
              La retroalimentación puede clasificarse en diferentes categorías
              según su enfoque y método de entrega:
            </p>
            <br />
            ...
            <p className="text-gray-700 text-base">
              ...
              <br />
              Para que la retroalimentación sea útil en la mejora de la
              escritura académica, se recomienda seguir estas estrategias:
              <br />
              <br />
            </p>
            <ul className="list-disc pl-5 text-gray-700 text-base">
              <li>
                1.{" "}
                <span className="font-bold">Ser específico y descriptivo:</span>{" "}
                En lugar de comentarios generales como "buen trabajo",
                proporcionar detalles concretos sobre lo que se hizo bien y lo
                que se puede mejorar.
              </li>
              <br />
              <li>
                2.{" "}
                <span className="font-bold">Enfocarse en el aprendizaje:</span>{" "}
                Centrar los comentarios en cómo el estudiante puede mejorar sus
                habilidades de escritura, no solo en la calificación.
              </li>
              <br />
              <li>
                3. <span className="font-bold">Proporcionar ejemplos:</span>{" "}
                Ofrecer modelos o ejemplos concretos de cómo mejorar una sección
                específica del texto.
              </li>
              <br />
              <li>
                4. <span className="font-bold">Usar un tono constructivo:</span>{" "}
                Mantener un tono positivo y alentador, incluso cuando se señalan
                áreas de mejora.
              </li>
              <br />
              <li>
                5. <span className="font-bold">Priorizar los comentarios:</span>{" "}
                5.Enfocarse en los aspectos más importantes para mejorar,
                evitando sobrecargar al estudiante con demasiada información.
              </li>
            </ul>
            <br />
            <p className="text-gray-700 text-base">
              <span className="font-bold">
                Implementación de la retroalimentación en el proceso de
                escritura{" "}
              </span>
              <br />
              La retroalimentación debe integrarse en diferentes etapas del
              proceso de escritura para maximizar su efectividad:
            </p>

            <br />
            <p className="text-gray-700 text-base">
              Es importante que los estudiantes tengan la oportunidad de aplicar
              la retroalimentación recibida en versiones posteriores de su
              trabajo. Esto mejora tanto la calidad del texto actual como el
              aprendizaje para futuras tareas de escritura.
              <br />
              <br />
              <span className="font-bold">
                Beneficios de la retroalimentación efectiva
              </span>
              <br />
              <br />
              Cuando se implementa correctamente, la retroalimentación en la
              escritura académica ofrece numerosos beneficios:
            </p>
            <br />
            <div className="flex justify-center my-2">
            ...
            <ul className="list-disc pl-5 text-gray-700 text-base">
              <li>
                1. <span className="font-bold">Mejora de habilidades:</span> Los
                estudiantes desarrollan una comprensión más profunda de los
                elementos de la escritura académica.
              </li>
              <br />
              <li>
                2. <span className="font-bold">Aumento de la confianza:</span>
                Los comentarios constructivos incrementan la confianza en sus
              ...
              <li>
                ...
                Estimula a los estudiantes a reflexionar sobre su trabajo y a
                tomar decisiones informadas para mejorarlo.
              </li>
              <br />
              <li>
                4.{" "}
                <span className="font-bold">
                  Personalizción del aprendizaje:
                </span>
                Permite abordar las necesidades específicas de cada estudiante
                en su proceso de escritura.
              </li>
              <br />
              <li>
                5.{" "}
                <span className="font-bold">Personalizción del personaje:</span>
                Estimula a los estudiantes a reflexionar sobre su trabajo y a
                tomar decisiones informadas para mejorarlo.
              </li>
            </ul>
            ...
            <div className="flex justify-center p-4 text-center">
              <p className="text-gray-700 text-base">
                ...
                <br />A continuación, te presento un nuevo texto con comentarios
                simulados, seguido de 6 preguntas, contesta adecuadamente.
              </p>
            </div>
          </section>
        </div>
